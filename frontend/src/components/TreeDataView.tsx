...
const TreeDataView = (props: TreeDataViewProps) => {
  const { selectedItem, populating, populateData } = props
  return (
    <div className="md:px-12 w-full">
      <div className="flex md:flex-col md:gap-6 flex-row justify-between">
        ...
        <button
          className="bg-blue-500 hover:bg-blue-700 w-fit text-white font-bold py-2 px-4 rounded disabled:opacity-50 disabled:bg-gray-400"
          disabled={populating}
          type="button"
